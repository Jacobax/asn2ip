...
if [ ! -f "${GEOIP_DATA_DIR}/GeoLite2-Country.mmdb" ]; then
    echo "The file ${GEOIP_DATA_DIR}/GeoLite2-Country.mmdb does not exist. downloading..."
    
    # 使用curl命令下载文件
    curl -L -o ${GEOIP_DATA_DIR}/GeoLite2-Country.mmdb "${proxygithub}https://github.com/P3TERX/GeoLite.mmdb/raw/download/GeoLite2-Country.mmdb"
...
while read -r line; do
	...
	result=$(mmdblookup --file ${GEOIP_DATA_DIR}/GeoLite2-Country.mmdb --ip $ip country iso_code)
